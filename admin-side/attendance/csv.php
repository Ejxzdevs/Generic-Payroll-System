					...
					<div class="schedule">
						<div class="schedule-header">
							<div class="sched-header-left" id="csv-div" >
								<form method="POST"	enctype="multipart/form-data" action="../../connection/admin-upload-csv.php">
								<label for="upload-entry">IMPORT <img src="../../icons/upload-btn.png" id="upload-btn" ></label>
								<div>
								<input type="file" name="file_upload" id="upload-entry" hidden>
								</div>
								<div>
								...
								<table class="sched-info">
									...
									<tbody>
										<tr>
											...
											<td><a href="csv_view_layout.php?id=<?php echo $fetch_all_csv['Csv_ID']; ?>"><img id="view" src="../../icons/view-action.svg"> </a><a href="delete_csv.php?id=<?php echo $fetch_all_csv['Csv_ID']; ?>" ><img id="delete-icon" src="../../icons/delete.svg"></a></td>

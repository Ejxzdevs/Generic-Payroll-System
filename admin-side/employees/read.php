...
// view info-emp
	...
	$emp_type = $res_view_emp['Employee_Types'];
	...
	$types = "SELECT * FROM `tbl_employee_types` WHERE Types != '$emp_type'";
	$query_types = mysqli_query($conn,$types);
	$fetch_types = mysqli_fetch_assoc($query_types);

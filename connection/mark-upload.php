...
foreach ($unfiltered_data as $employee) {
  ...
  echo  $id = str_replace("ID:", "", $unfiltered_employee[3]);
  echo "<br>";
            ...
            // halfday
             ...
             if($chunk[3] == '' && $chunk[4] == ''){
                    ...
                    if($min_diff_entry_2 > 240){
                        ...
                        $late_entry_b = $min_diff_entry_2 - $before_in_mins;
                    }
                    ...
                    $compute_reg_time = $late_entry_a + $late_entry_b - $before_in_mins ;

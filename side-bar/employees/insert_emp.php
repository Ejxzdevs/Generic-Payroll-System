...
$file = $_FILES['file'];
			...
			$employees_information = "INSERT INTO `tbl_employees_information`(`Employee_Image`, `Hire_Date`, `Daily_Rate`, `Schedule_ID`, `Position_ID`, `Department_ID`,`Employee_Types`) VALUES ('$fileDestination','$hire','$daily_rate','$id_schedule','$id_position','$id_department','$emp_type')";

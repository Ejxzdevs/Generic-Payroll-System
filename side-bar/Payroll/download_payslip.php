...
$total_tardines = $result_pay_ind_emp['total_late_deduction'] + $result_pay_ind_emp['total_undertime_deduction'];
...
// total_tax pay
		...
		$final_deduction = $total_tax_d + $total_d + $total_tardines;
...
$pdf->cell(95,10," " .$total_tardines ,'LR',1,'C');
...
$filename = "downloaded_payslip/ind.pdf";
